    ...
    return (
        <div className="px-6 lg:px-16 xl:px-28 relative">
            ...
            <div className="flex flex-col items-start justify-center w-full bg-white bg-opacity-10 rounded-[2rem] sm:rounded-[3rem] px-6 py-10 md:p-10 lg:p-14 my-10 space-y-6 z-10">
                <h1 className="text-6xl xl:text-8xl w-full md:w-11/12">We build <span className="text-secondary">products</span> that shape a better future</h1>
                <p className="text-base lg:text-lg text-gray-400 w-full md:w-3/5">We’re the architects of digital excellence across industries. We redefine business with cutting-edge digital strategies that invokes sector-wide transformation.</p>
