        ...
        <div className="bg-[url('/header-background-svg')] bg-no-repeat md:min-h-screen">
            <div className="flex flex-col items-start justify-center w-full bg-white bg-opacity-10 rounded-[2rem] sm:rounded-[3rem]  p-5 py-8 md:p-8 lg:p-10 my-10 space-y-6">
                ...
                <a href="#" className="relative group">
                    <button className="bg-white px-4 py-3 rounded-full group-hover:bg-[#064386] text-bg font-semibold group-hover:text-white transition-all duration-300 ease">Book a call <FaCaretRight className="inline-block ml-0.5 text-lg -translate-y-0.5" /></button>
